...
md5sum *fastq.gz > "${spring_temp}/md5sums_spring_wrapper$_${today}.txt"
...
cp "${spring_temp}/md5sums_spring_wrapper$_${today}.txt"  "${search_here}/md5sums_spring_wrapper$_${today}.txt"
